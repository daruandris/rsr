...
fn format_op(op: Op, args: &[String]) -> String {
    match op {
        ...
        Op::AddF | Op::AddV2 | Op::AddV3 | Op::AddM2 | Op::AddM3 => format!("({} + {})", args[0], args[1]),
        Op::SubF | Op::SubV2 | Op::SubV3 | Op::SubM2 | Op::SubM3 => format!("({} - {})", args[0], args[1]),
        ...
        Op::ScaleV2 | Op::ScaleV3 | Op::ScaleM2 | Op::ScaleM3 | Op::MulM2 | Op::MulM3 | Op::MulM2V2 | Op::MulM3V3 => format!("({} * {})", args[0], args[1]),
