...
pub unsafe fn eval_left_cauchy_green_m3(sp_m3: &mut usize, stack_m3: &mut [[f32x8; 9]; 32]) {
    ...
    let f = *stack_m3.get_unchecked(idx);
    *stack_m3.get_unchecked_mut(idx) = [
        f[0]*f[0] + f[1]*f[1] + f[2]*f[2], f[0]*f[3] + f[1]*f[4] + f[2]*f[5], f[0]*f[6] + f[1]*f[7] + f[2]*f[8],
        f[3]*f[0] + f[4]*f[1] + f[5]*f[2], f[3]*f[3] + f[4]*f[4] + f[5]*f[5], f[3]*f[6] + f[4]*f[7] + f[5]*f[8],
        f[6]*f[0] + f[7]*f[1] + f[8]*f[2], f[6]*f[3] + f[7]*f[4] + f[8]*f[5], f[6]*f[6] + f[7]*f[7] + f[8]*f[8],
    ];
}
...
pub unsafe fn eval_green_lagrange_strain_m3(sp_m3: &mut usize, stack_m3: &mut [[f32x8; 9]; 32]) {
    ...
    // E = 0.5 * (F^T F - I)
    *stack_m3.get_unchecked_mut(idx) = [
        half * (f[0]*f[0] + f[3]*f[3] + f[6]*f[6] - one), half * (f[0]*f[1] + f[3]*f[4] + f[6]*f[7]),       half * (f[0]*f[2] + f[3]*f[5] + f[6]*f[8]),
        half * (f[1]*f[0] + f[4]*f[3] + f[7]*f[6]),       half * (f[1]*f[1] + f[4]*f[4] + f[7]*f[7] - one), half * (f[1]*f[2] + f[4]*f[5] + f[7]*f[8]),
        half * (f[2]*f[0] + f[5]*f[3] + f[8]*f[6]),       half * (f[2]*f[1] + f[5]*f[4] + f[8]*f[7]),       half * (f[2]*f[2] + f[5]*f[5] + f[8]*f[8] - one),
    ];
}
...
pub unsafe fn eval_isochoric_invariant1(
    ...
    *sp_m3 -= 1;
    ...
    let det = f[0] * (f[4] * f[8] - f[5] * f[7]) - f[3] * (f[1] * f[8] - f[2] * f[7]) + f[6] * (f[1] * f[5] - f[2] * f[4]);
    let j_pow = (det.ln() * f32x8::splat(-2.0 / 3.0)).exp();
    
    let i1 = f[0]*f[0] + f[1]*f[1] + f[2]*f[2] + f[3]*f[3] + f[4]*f[4] + f[5]*f[5] + f[6]*f[6] + f[7]*f[7] + f[8]*f[8];
...
pub unsafe fn eval_isochoric_invariant2(
    ...
    *sp_m3 -= 1;
    ...
    let tr_c2 = c00*c00 + c01*c10 + c02*c20 + c10*c01 + c11*c11 + c12*c21 + c20*c02 + c21*c12 + c22*c22;
...
#[inline(always)]
pub unsafe fn eval_dual_right_cauchy_green_m3(sp_m3: &mut usize, stack_m3: &mut [[DualSimd; 9]; 32]) {
    let idx = *sp_m3 - 1;
    let f = *stack_m3.get_unchecked(idx);
    *stack_m3.get_unchecked_mut(idx) = [
        f[0]*f[0] + f[3]*f[3] + f[6]*f[6], f[0]*f[1] + f[3]*f[4] + f[6]*f[7], f[0]*f[2] + f[3]*f[5] + f[6]*f[8],
...
#[inline(always)]
pub unsafe fn eval_dual_left_cauchy_green_m3(sp_m3: &mut usize, stack_m3: &mut [[DualSimd; 9]; 32]) {
    let idx = *sp_m3 - 1;
    let f = *stack_m3.get_unchecked(idx);
    *stack_m3.get_unchecked_mut(idx) = [
        f[0]*f[0] + f[1]*f[1] + f[2]*f[2], f[0]*f[3] + f[1]*f[4] + f[2]*f[5], f[0]*f[6] + f[1]*f[7] + f[2]*f[8],
...
#[inline(always)]
pub unsafe fn eval_dual_green_lagrange_strain_m3(sp_m3: &mut usize, stack_m3: &mut [[DualSimd; 9]; 32]) {
    let idx = *sp_m3 - 1;
    let f = *stack_m3.get_unchecked(idx);
    let half = DualSimd::constant(f32x8::splat(0.5));
...
pub unsafe fn eval_dual_isochoric_invariant2(
    ...
    *stack_f.get_unchecked_mut(*sp_f) = j_pow * DualSimd::constant(f32x8::splat(0.5)) * (i1 * i1 - tr_c2);
    *sp_f += 1;
}