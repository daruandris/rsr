...
impl Domain for LinalgDomain {
    ...
    fn eval(op: Self::OpCode, ctx: &mut VmState) {
        unsafe {
            match op {
                LinalgOpCode::MakeVec2 => eval::eval_make_vec2(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v2,
                    &mut ctx.stack_v2,
                ),
                LinalgOpCode::MakeVec3 => eval::eval_make_vec3(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v3,
                    &mut ctx.stack_v3,
                ),
                LinalgOpCode::GetXV2 => eval::eval_get_x_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ),
                LinalgOpCode::GetYV2 => eval::eval_get_y_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ),
                LinalgOpCode::GetXV3 => eval::eval_get_x_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ),
                LinalgOpCode::GetYV3 => eval::eval_get_y_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ),
                LinalgOpCode::GetZV3 => eval::eval_get_z_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ...
                LinalgOpCode::ScaleV2 => eval::eval_scale_v2(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v2,
                    &mut ctx.stack_v2,
                ),
                LinalgOpCode::DotV2 => eval::eval_dot_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ),
                LinalgOpCode::NormV2 => eval::eval_norm_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ...
                LinalgOpCode::ScaleV3 => eval::eval_scale_v3(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v3,
                    &mut ctx.stack_v3,
                ),
                LinalgOpCode::DotV3 => eval::eval_dot_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ),
                LinalgOpCode::NormV3 => eval::eval_norm_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ...
                LinalgOpCode::MakeMat2 => eval::eval_make_mat2(
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                    &mut ctx.sp_m2,
                    &mut ctx.stack_m2,
                ...
                LinalgOpCode::ScaleM2 => eval::eval_scale_m2(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_m2,
                    &mut ctx.stack_m2,
                ...
                LinalgOpCode::MulM2V2 => eval::eval_mul_m2v2(
                    &mut ctx.sp_m2,
                    &ctx.stack_m2,
                    &mut ctx.sp_v2,
                    &mut ctx.stack_v2,
                ),
                LinalgOpCode::DetM2 => eval::eval_det_m2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m2,
                    &ctx.stack_m2,
                ),
                LinalgOpCode::TraceM2 => eval::eval_trace_m2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m2,
                    &ctx.stack_m2,
                ),
                LinalgOpCode::TransposeM2 => {
                    eval::eval_transpose_m2(&mut ctx.sp_m2, &mut ctx.stack_m2)
                }
                LinalgOpCode::InverseM2 => eval::eval_inverse_m2(&mut ctx.sp_m2, &mut ctx.stack_m2),

                LinalgOpCode::MakeMat3 => eval::eval_make_mat3(
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                    &mut ctx.sp_m3,
                    &mut ctx.stack_m3,
                ...
                LinalgOpCode::ScaleM3 => eval::eval_scale_m3(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_m3,
                    &mut ctx.stack_m3,
                ...
                LinalgOpCode::MulM3V3 => eval::eval_mul_m3v3(
                    &mut ctx.sp_m3,
                    &ctx.stack_m3,
                    &mut ctx.sp_v3,
                    &mut ctx.stack_v3,
                ),
                LinalgOpCode::DetM3 => eval::eval_det_m3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m3,
                    &ctx.stack_m3,
                ),
                LinalgOpCode::TraceM3 => eval::eval_trace_m3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m3,
                    &ctx.stack_m3,
                ),
                LinalgOpCode::TransposeM3 => {
                    eval::eval_transpose_m3(&mut ctx.sp_m3, &mut ctx.stack_m3)
                }
    ...
    fn try_simplify(
        ...
        if all_const
            && !const_vals.is_empty()
            && let Some(folded) = fold_linalg_constants(op, const_vals)
        {
        ...
        if const_vals.len() == 2 {
            ...
            match op {
                ...
                LinalgOpCode::ScaleV2
                | LinalgOpCode::ScaleV3
                | LinalgOpCode::ScaleM2
                | LinalgOpCode::ScaleM3 => {
                    if a_is_zero {
                        return SimplifyAction::ReplaceWithConstant(zero_for_op(op));
                    }
                    if a_is_one {
                ...
                LinalgOpCode::MulM2 | LinalgOpCode::MulM3 => {
                    let a_is_ident = const_vals[0].as_ref().is_some_and(|c| c.is_identity());
                    let b_is_ident = const_vals[1].as_ref().is_some_and(|c| c.is_identity());
                    if a_is_ident {
                        return SimplifyAction::KeepArg(1);
                    }
                    if b_is_ident {
    ...
    fn arity(op: Self::OpCode) -> usize {
        match op {
            ...
            LinalgOpCode::MakeVec2
            | LinalgOpCode::MakeMat2
            | LinalgOpCode::AddV2
            | LinalgOpCode::SubV2
            | LinalgOpCode::ScaleV2
            | LinalgOpCode::DotV2
    ...
    fn return_type(op: Self::OpCode) -> crate::engine::eval::types::ValueType {
        ...
        match op {
            ...
            | LinalgOpCode::NormV3
            | LinalgOpCode::DetM2
            | LinalgOpCode::TraceM2
            | LinalgOpCode::DetM3
            | LinalgOpCode::TraceM3 => ValueType::Float,

            LinalgOpCode::MakeVec2
            | LinalgOpCode::AddV2
            | LinalgOpCode::SubV2
            | LinalgOpCode::ScaleV2
            | LinalgOpCode::MulM2V2 => ValueType::Vec2,
            LinalgOpCode::MakeVec3
            | LinalgOpCode::AddV3
            | LinalgOpCode::SubV3
            | LinalgOpCode::ScaleV3
            | LinalgOpCode::CrossV3
            | LinalgOpCode::MulM3V3 => ValueType::Vec3,
            LinalgOpCode::MakeMat2
            | LinalgOpCode::AddM2
            | LinalgOpCode::SubM2
            | LinalgOpCode::ScaleM2
            | LinalgOpCode::MulM2
            | LinalgOpCode::TransposeM2
            | LinalgOpCode::InverseM2 => ValueType::Mat2,
            LinalgOpCode::MakeMat3
            | LinalgOpCode::AddM3
            | LinalgOpCode::SubM3
            | LinalgOpCode::ScaleM3
            | LinalgOpCode::MulM3
            | LinalgOpCode::TransposeM3
            | LinalgOpCode::InverseM3 => ValueType::Mat3,
        }
    }
    ...
    fn expected_types(op: Self::OpCode) -> &'static [crate::engine::eval::types::ValueType] {
        ...
        match op {
            ...
            LinalgOpCode::GetXV2 | LinalgOpCode::GetYV2 | LinalgOpCode::NormV2 => {
                &[ValueType::Vec2]
            }
            LinalgOpCode::AddV2 | LinalgOpCode::SubV2 | LinalgOpCode::DotV2 => {
                &[ValueType::Vec2, ValueType::Vec2]
            }
            ...
            | LinalgOpCode::GetYV3
            | LinalgOpCode::GetZV3
            | LinalgOpCode::NormV3 => &[ValueType::Vec3],
            LinalgOpCode::AddV3
            | LinalgOpCode::SubV3
            | LinalgOpCode::DotV3
            | LinalgOpCode::CrossV3 => &[ValueType::Vec3, ValueType::Vec3],
            LinalgOpCode::ScaleV3 => &[ValueType::Float, ValueType::Vec3],
            LinalgOpCode::MakeMat2 => &[ValueType::Vec2, ValueType::Vec2],
            LinalgOpCode::AddM2 | LinalgOpCode::SubM2 | LinalgOpCode::MulM2 => {
                &[ValueType::Mat2, ValueType::Mat2]
            }
            ...
            LinalgOpCode::AddM3 | LinalgOpCode::SubM3 | LinalgOpCode::MulM3 => {
                &[ValueType::Mat3, ValueType::Mat3]
            }
            LinalgOpCode::ScaleM3 => &[ValueType::Float, ValueType::Mat3],
            LinalgOpCode::MulM3V3 => &[ValueType::Mat3, ValueType::Vec3],
            LinalgOpCode::DetM3
            | LinalgOpCode::TraceM3
            | LinalgOpCode::TransposeM3
            | LinalgOpCode::InverseM3 => &[ValueType::Mat3],
        }
    }
    ...
    fn weight(op: Self::OpCode) -> usize {
        match op {
            ...
            | LinalgOpCode::TraceM2
            | LinalgOpCode::TransposeM2
            | LinalgOpCode::MulM3V3
            | LinalgOpCode::TraceM3
            | LinalgOpCode::TransposeM3 => 3,

            LinalgOpCode::CrossV3
            | LinalgOpCode::DetM2
            | LinalgOpCode::InverseM2
            | LinalgOpCode::MulM3 => 4,
    ...
    fn is_forbidden_child(parent: Self::OpCode, child: Self::OpCode) -> bool {
        match parent {
            ...
            LinalgOpCode::GetXV3 | LinalgOpCode::GetYV3 | LinalgOpCode::GetZV3 => {
                matches!(child, LinalgOpCode::MakeVec3)
            }
            _ => false,
        }
    }
    ...
    fn eval_dual(op: Self::OpCode, ctx: &mut DualVmState) {
        unsafe {
            match op {
                LinalgOpCode::MakeVec2 => autodiff::eval_make_dual_vec2(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v2,
                    &mut ctx.stack_v2,
                ),
                LinalgOpCode::MakeVec3 => autodiff::eval_make_dual_vec3(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v3,
                    &mut ctx.stack_v3,
                ),
                LinalgOpCode::GetXV2 => autodiff::eval_get_x_dual_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ),
                LinalgOpCode::GetYV2 => autodiff::eval_get_y_dual_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ),
                LinalgOpCode::GetXV3 => autodiff::eval_get_x_dual_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ),
                LinalgOpCode::GetYV3 => autodiff::eval_get_y_dual_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ),
                LinalgOpCode::GetZV3 => autodiff::eval_get_z_dual_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ...
                LinalgOpCode::AddV2 => {
                    autodiff::eval_add_dual_v2(&mut ctx.sp_v2, &mut ctx.stack_v2)
                }
                LinalgOpCode::SubV2 => {
                    autodiff::eval_sub_dual_v2(&mut ctx.sp_v2, &mut ctx.stack_v2)
                }
                LinalgOpCode::ScaleV2 => autodiff::eval_scale_dual_v2(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v2,
                    &mut ctx.stack_v2,
                ),
                LinalgOpCode::DotV2 => autodiff::eval_dot_dual_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ),
                LinalgOpCode::NormV2 => autodiff::eval_norm_dual_v2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                ...
                LinalgOpCode::AddV3 => {
                    autodiff::eval_add_dual_v3(&mut ctx.sp_v3, &mut ctx.stack_v3)
                }
                LinalgOpCode::SubV3 => {
                    autodiff::eval_sub_dual_v3(&mut ctx.sp_v3, &mut ctx.stack_v3)
                }
                LinalgOpCode::ScaleV3 => autodiff::eval_scale_dual_v3(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_v3,
                    &mut ctx.stack_v3,
                ),
                LinalgOpCode::DotV3 => autodiff::eval_dot_dual_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ),
                LinalgOpCode::NormV3 => autodiff::eval_norm_dual_v3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                ...
                LinalgOpCode::CrossV3 => {
                    autodiff::eval_cross_dual_v3(&mut ctx.sp_v3, &mut ctx.stack_v3)
                }

                LinalgOpCode::MakeMat2 => autodiff::eval_make_dual_mat2(
                    &mut ctx.sp_v2,
                    &ctx.stack_v2,
                    &mut ctx.sp_m2,
                    &mut ctx.stack_m2,
                ...
                LinalgOpCode::AddM2 => {
                    autodiff::eval_add_dual_m2(&mut ctx.sp_m2, &mut ctx.stack_m2)
                }
                LinalgOpCode::SubM2 => {
                    autodiff::eval_sub_dual_m2(&mut ctx.sp_m2, &mut ctx.stack_m2)
                }
                LinalgOpCode::ScaleM2 => autodiff::eval_scale_dual_m2(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_m2,
                    &mut ctx.stack_m2,
                ...
                LinalgOpCode::MulM2 => {
                    autodiff::eval_mul_dual_m2(&mut ctx.sp_m2, &mut ctx.stack_m2)
                }
                LinalgOpCode::MulM2V2 => autodiff::eval_mul_dual_m2v2(
                    &mut ctx.sp_m2,
                    &ctx.stack_m2,
                    &mut ctx.sp_v2,
                    &mut ctx.stack_v2,
                ),
                LinalgOpCode::DetM2 => autodiff::eval_det_dual_m2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m2,
                    &ctx.stack_m2,
                ),
                LinalgOpCode::TraceM2 => autodiff::eval_trace_dual_m2(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m2,
                    &ctx.stack_m2,
                ...
                LinalgOpCode::TransposeM2 => {
                    autodiff::eval_transpose_dual_m2(&mut ctx.sp_m2, &mut ctx.stack_m2)
                }
                LinalgOpCode::InverseM2 => {}

                LinalgOpCode::MakeMat3 => autodiff::eval_make_dual_mat3(
                    &mut ctx.sp_v3,
                    &ctx.stack_v3,
                    &mut ctx.sp_m3,
                    &mut ctx.stack_m3,
                ...
                LinalgOpCode::AddM3 => {
                    autodiff::eval_add_dual_m3(&mut ctx.sp_m3, &mut ctx.stack_m3)
                }
                LinalgOpCode::SubM3 => {
                    autodiff::eval_sub_dual_m3(&mut ctx.sp_m3, &mut ctx.stack_m3)
                }
                LinalgOpCode::ScaleM3 => autodiff::eval_scale_dual_m3(
                    &mut ctx.sp_f,
                    &ctx.stack_f,
                    &mut ctx.sp_m3,
                    &mut ctx.stack_m3,
                ...
                LinalgOpCode::MulM3 => {
                    autodiff::eval_mul_dual_m3(&mut ctx.sp_m3, &mut ctx.stack_m3)
                }
                LinalgOpCode::MulM3V3 => autodiff::eval_mul_dual_m3v3(
                    &mut ctx.sp_m3,
                    &ctx.stack_m3,
                    &mut ctx.sp_v3,
                    &mut ctx.stack_v3,
                ),
                LinalgOpCode::DetM3 => autodiff::eval_det_dual_m3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m3,
                    &ctx.stack_m3,
                ),
                LinalgOpCode::TraceM3 => autodiff::eval_trace_dual_m3(
                    &mut ctx.sp_f,
                    &mut ctx.stack_f,
                    &mut ctx.sp_m3,
                    &ctx.stack_m3,
                ...
                LinalgOpCode::TransposeM3 => {
                    autodiff::eval_transpose_dual_m3(&mut ctx.sp_m3, &mut ctx.stack_m3)
                }
    ...
    fn format_op(op: Self::OpCode, args: &[String]) -> String {
        match op {
            ...
            | LinalgOpCode::AddV3
            | LinalgOpCode::AddM2
            | LinalgOpCode::AddM3 => format!("({} + {})", args[0], args[1]),
            LinalgOpCode::SubV2
            | LinalgOpCode::SubV3
            | LinalgOpCode::SubM2
            | LinalgOpCode::SubM3 => format!("({} - {})", args[0], args[1]),
            LinalgOpCode::ScaleV2
            | LinalgOpCode::ScaleV3
            | LinalgOpCode::ScaleM2
            | LinalgOpCode::ScaleM3
...
fn zero_for_op(op: LinalgOpCode) -> Scalar {
    match op {
        LinalgOpCode::SubV2 | LinalgOpCode::ScaleV2 | LinalgOpCode::MulM2V2 => {
            Scalar::Vec2([0.0; 2])
        }
        LinalgOpCode::SubV3
        | LinalgOpCode::ScaleV3
        | LinalgOpCode::CrossV3
        | LinalgOpCode::MulM3V3 => Scalar::Vec3([0.0; 3]),
...
fn fold_linalg_constants(op: LinalgOpCode, const_vals: &[Option<Scalar>]) -> Option<Scalar> {
    ...
    match (op, args.as_slice()) {
        ...
        (LinalgOpCode::AddV3, [Vec3(a), Vec3(b)]) => {
            Some(Vec3([a[0] + b[0], a[1] + b[1], a[2] + b[2]]))
        }
        (LinalgOpCode::SubV3, [Vec3(a), Vec3(b)]) => {
            Some(Vec3([a[0] - b[0], a[1] - b[1], a[2] - b[2]]))
        }
        (LinalgOpCode::ScaleV3, [Float(s), Vec3(v)]) => Some(Vec3([s * v[0], s * v[1], s * v[2]])),
        (LinalgOpCode::DotV3, [Vec3(a), Vec3(b)]) => {
            Some(Float(a[0] * b[0] + a[1] * b[1] + a[2] * b[2]))
        }
        (LinalgOpCode::NormV3, [Vec3(v)]) => {
            Some(Float((v[0] * v[0] + v[1] * v[1] + v[2] * v[2]).sqrt()))
        }
        (LinalgOpCode::CrossV3, [Vec3(a), Vec3(b)]) => Some(Vec3([
            a[1] * b[2] - a[2] * b[1],
            a[2] * b[0] - a[0] * b[2],
            a[0] * b[1] - a[1] * b[0],
        ])),
        (LinalgOpCode::MakeMat2, [Vec2(c0), Vec2(c1)]) => Some(Mat2([c0[0], c0[1], c1[0], c1[1]])),
        (LinalgOpCode::AddM2, [Mat2(a), Mat2(b)]) => {
            Some(Mat2([a[0] + b[0], a[1] + b[1], a[2] + b[2], a[3] + b[3]]))
        }
        (LinalgOpCode::SubM2, [Mat2(a), Mat2(b)]) => {
            Some(Mat2([a[0] - b[0], a[1] - b[1], a[2] - b[2], a[3] - b[3]]))
        }
        (LinalgOpCode::ScaleM2, [Float(s), Mat2(m)]) => {
            Some(Mat2([s * m[0], s * m[1], s * m[2], s * m[3]]))
        }
        (LinalgOpCode::MulM2, [Mat2(a), Mat2(b)]) => Some(Mat2([
            a[0] * b[0] + a[2] * b[1],
            a[1] * b[0] + a[3] * b[1],
            a[0] * b[2] + a[2] * b[3],
            a[1] * b[2] + a[3] * b[3],
        ])),
        (LinalgOpCode::MulM2V2, [Mat2(m), Vec2(v)]) => {
        ...
        (LinalgOpCode::MakeMat3, [Vec3(c0), Vec3(c1), Vec3(c2)]) => Some(Mat3([
            c0[0], c0[1], c0[2], c1[0], c1[1], c1[2], c2[0], c2[1], c2[2],
        ])),
        (LinalgOpCode::AddM3, [Mat3(a), Mat3(b)]) => Some(Mat3([
            a[0] + b[0],
            a[1] + b[1],
            a[2] + b[2],
            a[3] + b[3],
        ...
        (LinalgOpCode::SubM3, [Mat3(a), Mat3(b)]) => Some(Mat3([
            a[0] - b[0],
            a[1] - b[1],
            a[2] - b[2],
            a[3] - b[3],
        ...
        (LinalgOpCode::ScaleM3, [Float(s), Mat3(m)]) => Some(Mat3([
            s * m[0],
            s * m[1],
            s * m[2],
            s * m[3],
        ...
        (LinalgOpCode::TransposeM3, [Mat3(m)]) => {
