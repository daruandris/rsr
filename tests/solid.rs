...
fn solid_4_st_venant_kirchhoff() {
    ...
    for _ in 0..1000 {
        ...
        let e = [
            0.5 * (f[0] * f[0] + f[3] * f[3] + f[6] * f[6] - 1.0),
            0.5 * (f[0] * f[1] + f[3] * f[4] + f[6] * f[7]),
            0.5 * (f[0] * f[2] + f[3] * f[5] + f[6] * f[8]),
            0.5 * (f[1] * f[0] + f[4] * f[3] + f[7] * f[6]),
            0.5 * (f[1] * f[1] + f[4] * f[4] + f[7] * f[7] - 1.0),
            0.5 * (f[1] * f[2] + f[4] * f[5] + f[7] * f[8]),
            0.5 * (f[2] * f[0] + f[5] * f[3] + f[8] * f[6]),
            0.5 * (f[2] * f[1] + f[5] * f[4] + f[8] * f[7]),
            0.5 * (f[2] * f[2] + f[5] * f[5] + f[8] * f[8] - 1.0),
        ];
