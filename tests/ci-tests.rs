...
fn create_linear_data() -> (SimdDataset, usize) {
    // Cél: y = 2 * X0 + 5
    let mut x = Vec::new();
    let mut y = Vec::new();
    for i in 0..50 {
...
fn create_quadratic_data() -> (SimdDataset, usize) {
    // Cél: y = X0^2 - 10
    let mut x = Vec::new();
    let mut y = Vec::new();
    for i in 0..50 {
...
fn create_sine_wave_data() -> (SimdDataset, usize) {
    let mut x = Vec::new();
    let mut y = Vec::new();
    for i in 0..50 {
...
// Cél: y = exp(0.5 * X0)
fn create_exponential_data() -> (SimdDataset, usize) {
    let mut x = Vec::new();
    let mut y = Vec::new();
    for i in 0..50 {
